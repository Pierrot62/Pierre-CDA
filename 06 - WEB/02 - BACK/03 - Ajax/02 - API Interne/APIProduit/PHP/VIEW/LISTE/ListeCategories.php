...
echo '<div class="caseListe titreListe grid-columns-span-4">Liste des Categories </div>';
...
echo '<div class="caseListe labelListe">LibelleCategorie</div>';
...
{
echo '<div class="caseListe donneeListe">'.$unObjet->getLibelleCategorie().'</div>';
