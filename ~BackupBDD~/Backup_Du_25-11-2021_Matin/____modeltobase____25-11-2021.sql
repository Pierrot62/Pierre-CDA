...
INSERT INTO `__efmigrationshistory` VALUES ('20211124123625_m1','5.0.12'),('20211124125601_m2','5.0.12'),('20211124125717_m3','5.0.12');
...
CREATE TABLE `fromage` (
  `idFromage` int(11) NOT NULL AUTO_INCREMENT,
  `nomFromage` text,
  `prixFromage` double NOT NULL,
  PRIMARY KEY (`idFromage`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fruit` (
  `idFruit` int(11) NOT NULL AUTO_INCREMENT,
  `nomFruit` text,
  `prixFruit` double NOT NULL,
  `paysFruit` double NOT NULL,
  PRIMARY KEY (`idFruit`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-25 12:22:45
