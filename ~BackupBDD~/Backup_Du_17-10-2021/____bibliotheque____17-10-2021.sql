...
CREATE TABLE `abonnes` (
  ...
  UNIQUE KEY `MatriculeAbonne` (`MatriculeAbonne`),
...
INSERT INTO `categoriesprofessionnelles` VALUES (1,'Ouvrier'),(2,'Employer'),(3,'Techniciens'),(4,'Agens de maitrise'),(5,'Ingénieurs'),(6,'Cadres'),(7,'Dieu');
...
CREATE TABLE `exemplaires` (
  ...
  UNIQUE KEY `CodeRayon` (`CodeRayon`),
...
CREATE TABLE `identifications` (
  `idIdentifications` int(11) NOT NULL AUTO_INCREMENT,
  `IdLivre` int(11) NOT NULL,
  `IdMotCle` int(11) NOT NULL,
  PRIMARY KEY (`idIdentifications`),
